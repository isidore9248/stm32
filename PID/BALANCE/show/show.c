...
void oled_show(void)
{
	...
	if(Menu_MODE==1&&Flag_OLED!=1)//位置模式
	{
	   ...
	   else if(Flag_OLED!=1)
	   {
	  	...
	  	//=============第6行显示测量速度和目标速度=======================//			
			OLED_ShowString(00,50,"T:");	 	
				if(Target_Velocity>=0)
				{
					OLED_ShowString(15,50,"+");	
					OLED_ShowNumber(20,50,Target_Velocity,5,12) ;	 	//目标速度
				}
				else 
				{
					OLED_ShowString(15,50,"-");	
			...
			OLED_ShowString(60,50,"P:");   
				if(Encoder>=0)
				{
					OLED_ShowString(70,50,"+");	
					OLED_ShowNumber(80,50,Encoder,5,12) ;	 	//目标速度
				}
				else 
				{
					OLED_ShowString(70,50,"-");	
				...
				//OLED_ShowNumber(95,50,(u16)Encoder,5,12);            //测量速度
